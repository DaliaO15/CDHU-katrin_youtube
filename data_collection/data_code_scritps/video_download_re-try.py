...
def video_download(df, root_folder:str): 
    ...
    file_path = 'downloads_status_re-try.parquet'
    ...
    for idx in range(0,df.shape[0]):
        ...
        try:
            ...
            with YoutubeDL(ydl_opts) as ydl:
                ydl.download(['https://www.' + video_url]) 
        ...
        info = {'Channel':[channel_name],'Video_url':[video_url], 'Status_2':[collected_status]} 
...
def main():
    df = pd.read_parquet('error_videos.parquet')
    #df = df.iloc[0:2]
